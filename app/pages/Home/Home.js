            ...
            <SafeAreaView style={{flex:1,backgroundColor:colors.background2}}>
                ...
                >
                    <View style={{flex:1}}>
                        ...
                        <Text style={{...FONTS.font,color:colors.text,lineHeight:17}}>{UserName}</Text>
                    </View>
                    <TouchableOpacity
                ...
                <ScrollView>
                    ...
                    {/* <View style={{
                        ...
                        <View style={[GlobalStyleSheet.container,{paddingBottom:0,paddingTop:8}]}>
                            <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
                                <Text style={{...FONTS.h4,color:colors.title}}>Loans</Text>
                                <TouchableOpacity>
                                    <Text style={{...FONTS.font,color:COLORS.primary3}}>View all</Text>
                                </TouchableOpacity>
                            </View>
                        ...
                        <View style={[GlobalStyleSheet.container,{paddingBottom:0,paddingTop:8, marginTop:40}]}>
                            {/* <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
