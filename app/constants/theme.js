...
export const ICONS = {
	...
	grid : `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10 3H3V10H10V3Z" stroke="#4cb1ff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M21 3H14V10H21V3Z" stroke="#4cb1ff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M21 14H14V21H21V14Z" stroke="#4cb1ff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M10 14H3V21H10V14Z" stroke="#4cb1ff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
	list : `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8 6H21" stroke="#4cb1ff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M8 12H21" stroke="#4cb1ff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M8 18H21" stroke="#4cb1ff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M3 6H3.01" stroke="#4cb1ff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M3 12H3.01" stroke="#4cb1ff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M3 18H3.01" stroke="#4cb1ff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
...
export const IMAGES = {
	...
	pl : require('../assets/images/global/PL.png'),
	EL : require('../assets/images/global/EL.png'),
	HL : require('../assets/images/global/HL.png'),
	GL : require('../assets/images/global/GL.png'),
	VL : require('../assets/images/global/CL.png'),
	...
	background : require('../../apps/social_app/assets/images/background.png'), 
	light : require('../../apps/social_app/assets/images/light.png'), 
