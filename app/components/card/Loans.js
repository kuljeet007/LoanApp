...
const Loans = ({Tenure,LoanNo,LoanAmount,EMI,InterestRate,navigate,Id , color}) => {
            ...
            >
                <View style={{position:'relative'}}>
                    ...
                    >
                        ...
                        <Text style={{...FONTS.font,color:COLORS.white,marginBottom:1}}>{Tenure}</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={{
                            position:'absolute',
                    ...
                    >
                        ...
                        <Text style={{...FONTS.font,color:COLORS.white,marginBottom:1}}>{InterestRate} </Text>
                    </TouchableOpacity>
                </View>
                <View style={{paddingHorizontal:12,paddingTop:15,paddingBottom:12}}>
                    ...
                    <Text style={{...FONTS.h6,color:colors.title,marginBottom:15}}>Loan No : {LoanNo}</Text>
                    <Text style={{...FONTS.h6,color:colors.title,marginBottom:15}}>Amount : ₹{LoanAmount}</Text>
                    <Text style={{...FONTS.h6,color:colors.title,marginBottom:15}}>Interest : {InterestRate}%</Text>
                    ...
                    <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
                        <TouchableOpacity
                          onPress={() => navigation.navigate('LoanDetails',{Id : Id})}
                        ...
                        <Text style={{...FONTS.h4,color:colors.title}}>EMI : ₹{EMI}</Text>
                    </View>
                </View>
            </View>
        </>
